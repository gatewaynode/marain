...
use crate::{Result, EntitiesError};
    ...
    fn generate_create_table_sql(&self) -> String {
        ...
        for field in &self.definition.fields {
            if field.cardinality == 1 {
                ...
                let reference_column = format!(
                    "field_reference_{} TEXT DEFAULT '{}'",
                    field.id,
                    table_name
                );
...
mod tests {
    ...
    fn test_generate_column_sql() {
        ...
        assert_eq!(entity.generate_column_sql(&text_field), "title TEXT NOT NULL");
