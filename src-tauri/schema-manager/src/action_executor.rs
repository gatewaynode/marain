...
impl ActionExecutor {
    ...
    pub async fn execute_actions(&self, actions: Vec<Action>) -> ExecutionResult {
        ...
        info!(
            "Executing {} actions (dry_run: {})",
            total_actions, self.dry_run
        );
    ...
    async fn execute_single_action(
        ...
        match action {
            ...
            Action::AddColumn {
                ...
                debug!(
                    "Adding column {} to table {} for entity {}",
            ...
            Action::DropColumn {
                ...
                warn!(
                    "SQLite doesn't support DROP COLUMN directly. This requires table recreation."
                );
            ...
            Action::ModifyColumn {
                ...
                warn!(
                    "SQLite doesn't support ALTER COLUMN directly. This requires table recreation."
                );
                Err(ExecutionError::ActionFailed(
...
mod tests {
    ...
    async fn test_dry_run_execution() {
        ...
        let actions = vec![Action::CreateTable {
