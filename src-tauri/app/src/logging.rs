...
pub fn init_logging(env_paths: &EnvPaths) -> Result<tracing_appender::non_blocking::WorkerGuard, Box<dyn std::error::Error>> {
    ...
    tracing::info!("Log files are being written to: {:?}", env_paths.data_path.join("logs"));
